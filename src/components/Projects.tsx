...
const projectData: Project[] = [
    {
        ...
        githubLink: "https://github.com/mkamrul9/funding-panda-client",
        challenges:
    ...
    },
    {
        ...
        githubLink: "https://github.com/mkamrul9/skillbridge-client",
        challenges:
    ...
    },
    {
        ...
        githubLink: "https://github.com/mkamrul9/kanbansync-client",
        challenges:
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {projectData.map((project) => (
                        <div
                            key={project.id}
                            className="flex flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition-all hover:shadow-xl"
                        >
                            <div className="relative flex h-48 w-full items-center justify-center bg-gray-200 text-gray-400">
                                <span>[Image for {project.name}]</span>
                            </div>
                            <div className="flex flex-1 flex-col p-6">
                                ...
                                <button
                                    ...
                                    className="w-full rounded-xl bg-blue-50 py-3 font-medium text-blue-600 transition-colors hover:bg-blue-600 hover:text-white"
                                >
                                    View More / Details
                                </button>
                            </div>
                ...
                {selectedProject && (
                    <div className="fixed inset-0 z-100 flex items-center justify-center bg-gray-900/60 p-4 backdrop-blur-sm">
                        <div className="relative max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-3xl bg-white shadow-2xl duration-200 animate-in fade-in zoom-in-95">
                            <button
                                onClick={() => setSelectedProject(null)}
                                className="absolute top-4 right-4 z-10 rounded-full bg-gray-100 p-2 transition-colors hover:bg-red-100 hover:text-red-600"
                            ...
                            <div className="p-8 sm:p-10">
                                ...
                                <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-2">
                                    <div className="rounded-xl border border-orange-100 bg-orange-50 p-5">
                                        ...
                                        <p className="text-sm leading-relaxed text-orange-900/80">
                                ...
                                <div className="flex flex-col gap-4 border-t border-gray-100 pt-4 sm:flex-row">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-gray-900 px-6 py-3 font-medium text-white transition-colors hover:bg-gray-800"
                                    >
                                        <FolderGit2 size={20} />
                                        Client Repository
                                    </a>
